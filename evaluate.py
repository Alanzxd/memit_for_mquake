...
DS_DICT = {
    ...
    "zsre": (MENDQADataset, compute_rewrite_quality_mquake),
        ...
        flattened_rewrites = [
            {
                ...
                "target_new": {"str": record["requested_rewrite"]["target_new"]["str"]},  # 保持嵌套结构
                "target_true": {"str": record["requested_rewrite"]["target_true"]["str"]}  # 保持嵌套结构
            }
            for record in record_chunks
        ]
